                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td colspan="2"
                                    ...
                                    We appreciate your interest in us and look forward to speaking with you soon.
                                </td>
                            </tr>
...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
    ...
    $mail->Username   = 'hardikrana84@gmail.com';                     //SMTP username
    $mail->Password   = 'egczhmiamzjpdwvv';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Admin
    $mail->setFrom('noreply@svmobi.com', 'SVMobi');
    $mail->addAddress('hardikrana84@gmail.com');     //Add a recipient
    
    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'You have new enquire';
